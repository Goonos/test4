...
---------- ------------------ ---------- --------
         1 ACTIVE                4435212 10:17:45
         2 ACTIVE                4435212 10:17:45
         3 ACTIVE                4435212 10:17:45
         4 ACTIVE                4435212 10:17:45
         5 ACTIVE                4435212 10:17:45
         7 ACTIVE                4435212 10:17:45
         8 ACTIVE                4435212 10:17:45
         9 ACTIVE                4435212 10:17:45
        10 ACTIVE                4435212 10:17:45
        11 ACTIVE                4435212 10:17:45
CREATE TABLE hr.emp104(id NUMBER, memo VARCHAR2(30)) TABLESPACE users;
INSERT INTO hr.emp104 VALUES (11, 'during backup');

COMMIT;

!cp -p /u02/oradata/orcl/ *.dbf /fra/backup/

!rm -f /fra/backup/temp01.dbf
...
DELETE FROM hr.emp104 WHERE id <= 11;
...
!\mkdir -p /fra/backup/cold/20260914_before_105

!\cp -p /u02/oradata/orcl/ *.dbf /fra/backup/cold/20260914_before_105/
...
SHUTDOWN IMMEDIATE
STARTUP MOUNT
!cp -p /fra/backup/ *.dbf /u02/oradata/orcl/

SELECT file#, checkpoint_change#,
TO_CHAR(checkpoint_time, 'HH24:MI:SS') AS ckpt_time, fuzzy
FROM  v$datafile_header ORDER BY file#;

     FILE# CHECKPOINT_CHANGE# CKPT_TIM FUZ
---------- ------------------ -------- ---
         1            4435212 10:17:45 YES
         2            4435212 10:17:45 YES
         3            4435212 10:17:45 YES
         4            4435212 10:17:45 YES
         5            4435212 10:17:45 YES
         7            4435212 10:17:45 YES
         8            4435212 10:17:45 YES
         9            4435212 10:17:45 YES
        10            4435212 10:17:45 YES
        11            4435212 10:17:45 YES

RECOVER DATABASE UNTIL TIME '2026-09-14 10:05:00';

ALTER DATABASE OPEN RESETLOGS;

SELECT file#, checkpoint_change#, fuzzy FROM v$datafile_header ORDER BY file#;

RECOVER DATABASE UNTIL TIME '2026-09-14 10:26:44';
